                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{route('order.payment.confirm',$order->id)}}"
                                                    class="btn btn-primary mt-2">Confirm Payment</a>
                                                <a href="{{route('order.payment.canceled',$order->id)}}"
                                                    class="btn btn-danger mt-2">Cancel Payment</a>
                                            </td>
                                        </tr>
                                        @endif
                                        @endforeach
                                ...
                                <table id="order_processed"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$order->status}}</td>
                                            <td>
                                                <a href="{{route('order.details',$order->id)}}" class="btn btn-success">View Details</a>
                                            </td>
                                        </tr>
                                        @endif
                                        @endforeach
